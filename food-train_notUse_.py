...
def setup_generator(train_path, test_path, batch_size, dimentions):
    ...
    validation_generator = test_datagen.flow_from_directory(
        test_path, target_size=dimentions, batch_size=batch_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p',
                        ...
                        dest='model_path',
                        type=str,
                        default='saved_models/food-101-epoch-01.hdf5')
    ...
    parser.add_argument('-d',
                        help='decimal value for dropout',
                        dest='dropout',
                        type=float,
                        default=0.2)
    ...
    if args.mode == 'train':
        ...
        callbacks.append(
            ModelCheckpoint(
                filepath=
                'saved_models/weights.epoch-{epoch:02d}-val_loss-{val_loss:.2f}.hdf5',
                verbose=1,
                save_best_only=True))
